...
class AdministratorViewSet(viewsets.ViewSet):
    ...
    def register(self, request):
        ...
        # Format the admin_id before saving
        if 'admin_id' in request.data:
            request.data['admin_id'] = self.format_ssn(request.data['admin_id'])
        ...
        if serializer.is_valid():
            try:
                ...
                return Response({
                    ...
                    'admin_id': admin.admin_id  # This will now be formatted
